...
# 2. Compilar binário nativo Flutter v1.0.0e com as credenciais embutidas
Write-Host "[2/4] Compilando Flutter Release v1.0.0e para Windows..." -ForegroundColor Yellow
...
Write-Host "[4/4] Compilando PapoCall-Setup.exe v1.0.0e..." -ForegroundColor Yellow
